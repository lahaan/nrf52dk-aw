...
/*
v1.1-241025b log RTT SAMPLE:
05> Waiting for +SHREQ response...
05> <<< +SHREQ: "GET",200,27
05> HTTPS Status: 200, Size: 27
05> Confirmed data size: 27
05> Reading response data, size: 27
...
05> Confirmed data size: 25
05> Reading response data, size: 25
...
05> SBC handoff IRQ (pin val=1) -> scheduling sbc_handoff_work
05> SBC handoff work handler started (pin val=1)
05> SBC became ACTIVE -> MCU relinquishes modem and cleans up
05> cleanup_http_session: SBC active - skipping AT, marking session inactive
05> SBC active - MCU waiting/idle
05> SBC active - MCU waiting/idle
05> SBC active - MCU waiting/idle
05> SBC handoff IRQ (pin val=0) -> scheduling sbc_handoff_work
05> SBC handoff work handler started (pin val=0)
05> SBC handed off -> MCU attempting to resume control
...
05> Confirmed data size: 5
05> Reading response data, size: 5
...
05> Waiting for +SHREQ response...
05> <<< +SHREQ: "GET",200,28
05> HTTPS Status: 200, Size: 28
05> Confirmed data size: 28
05> Reading response data, size: 28
05> Boutta READ packet n=6
05> >>> AT+SHREAD=0,28
05> <<< OK
05> <<< +SHREAD: 28
05> <<< CMD:LED_OFF,PIN:17,DATA:none
05> Command data captured: CMD:LED_OFF,PIN:17,DATA:none
05> Received command: CMD:LED_OFF,PIN:17,DATA:none
05> Processing command: CMD:LED_OFF,PIN:17,DATA:none
05> Parsed - CMD: LED_OFF, PIN: 17, DATA: none
05> Executing: LED_OFF on pin 17
05> LED OFF
05> >>> AT+SHREQ="/api/ack/device001/OK",1
05> <<< OK
05> <<< +SHREQ: "GET",200,2
...
05> >>> AT+SHCHEAD
05> SBC handoff IRQ (pin val=0) -> scheduling sbc_handoff_work
05> Clear headers failed
05> Cleaning up HTTPS session...
05> >>> AT+SHDISC
05> HTTPS session not active
05> Failed to setup HTTPS session after handoff
05> Sending pending ACK: AT+SHREQ="/api/ack/device001/OK",1
05> >>> AT+SHREQ="/api/ack/device001/OK",1
05> SBC handoff IRQ (pin val=1) -> scheduling sbc_handoff_work
05> SBC handoff IRQ (pin val=0) -> scheduling sbc_handoff_work
